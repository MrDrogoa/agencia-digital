...
const base =
  "btn-contact relative cursor-pointer font-secondary font-bold rounded-3xl px-4 py-2 md:px-6 lg:px-8 text-sm lg:text-base xl:text-lg border-2 border-white text-white transition-all duration-500 ease-in overflow-hidden z-1 inline-block";
...
<style scoped>
@import "@/assets/css/buttons/contact.css";
</style>
