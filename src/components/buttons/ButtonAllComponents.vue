...
const base =
  "btn-all relative cursor-pointer font-secondary bg-linear-to-r from-[#FF6D2A] to-[#FFB446] transition-all duration-300 font-bold rounded-3xl px-4 py-2 md:px-6 lg:px-8 text-xs md:text-sm lg:text-base xl:text-lg text-white mt-2 md:mt-4 lg:mt-6 overflow-hidden";
